  ...
  return (
    <div>
        <div className="container">
            <h2 className='text-center mb-5'>Why choose Mahikeng Technical College ?</h2>
            <div className='row g-4'>
                ...
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            At Mahikeng Technical College, we know a happy student is a successful student. That's why we go beyond just academics. We foster a supportive community with dedicated instructors who are there to guide you. Our student clubs and activities offer a chance to connect with like-minded peers and explore your interests outside the classroom. It's this focus on a well-rounded learning experience that keeps our students happy and engaged, setting them up for success in their chosen careers.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        <div className='mt-3'>
                        <img src="expert.png" alt="React University London" className="mr-2"style={{ maxWidth: '500%', height: 'auto' }} />
                        </div>
                        <Card.Body>
                            <Card.Title className='text-center text-capitalize mb-3'>
                            ...
                            <Card.Text className='text-justify'>
                            At Mahikeng Technical College, we bridge the gap between theory and practice. Not only will you gain a strong foundation in your chosen field, but we'll also connect you directly with industry professionals. This ensures you graduate with the practical skills and experience employers are looking for, giving you a head start in your career.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
